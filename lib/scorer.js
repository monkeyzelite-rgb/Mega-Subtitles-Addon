...
function calculateScore(subTitle, videoFilenameLower, signal, videoSourceTypeOverride = null) {
    ...
    if (videoFilenameLower) {
        ...
        // Penalizam DOAR cand video-ul declara explicit versiunea.
        // Daca filename-ul nu spune nimic, nu presupunem ca e theatrical —
        // multe release-uri (ex. LOTR 4K) sunt extended fara sa o scrie.
        ...
        if (videoRuntimeVer) {
            // Video declara explicit: extended / directors / unrated / etc.
            ...
            // sub fara versiune declarata → fara penalizare, nu stim
        } else if (videoIsTheatrical) {
            // Video declara explicit theatrical
            ...
            // Video NU declara versiunea — nu penalizam nimic.
            // Dam un mic bonus subtitrarilor care nu declara nici ele versiune,
            // ca tiebreaker usor spre varianta "standard".
