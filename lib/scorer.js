...
function getSourceType(text) {
    ...
    if (LOW_SOURCES.some(s => hasKeyword(t, s)) || AMBIGUOUS_LOW_UPPER.test(raw) || AMBIGUOUS_LOW_DOTTED.test(t)) return 'low';
    return null;
}
...
module.exports = { calculateScore, getSourceType, detectFramerate, detectVersions, hasKeyword, parseEpisodeRefs, parseSeasonRanges, extractYears };
